    ...
    return SafeArea(
      child: ColumnWidget(
        ...
        children: <WarehouseEntryItem>[
          if (PermissionHelper.view(AbilitySubject.greenBeanManagement) &&
          ...
          if (PermissionHelper.view(AbilitySubject.roastedBeanManagement))
            .new(
              title: 'Hạt rang',
          ...
          if (PermissionHelper.view(AbilitySubject.brandManagement) &&
