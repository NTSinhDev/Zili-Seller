...
class _CompleteBottomSheet extends StatefulWidget {
  final RoastingSlipDetail detail;
  final Function(double weight, String roastingSlipId, String? note) onSubmit;
  const _CompleteBottomSheet({required this.detail, required this.onSubmit});

  @override
  State<_CompleteBottomSheet> createState() => _CompleteBottomSheetState();
}

class _CompleteBottomSheetState extends State<_CompleteBottomSheet> {
  ...
  ProductVariant? get _variant => widget.detail.roastedVariant;

  @override
  Widget build(BuildContext context) {
    final availableQty = widget.detail.roastedEstimateWeight;
    ...
    return SafeArea(
      child: SingleChildScrollView(
        child: ColumnWidget(
          children: [
            BottomSheetHeader(
              title: 'Xác nhận hoàn thành phiếu rang',
                ...
                children: [
                  ...
                  InputFormField(
                    ...
                    validator: (value) {
                      ...
                      if (text.isEmpty) {
                        return 'Vui lòng nhập khối lượng thực tế';
                      }
                      ...
                      if (availableQty > 0 && parsed > availableQty) {
                        return 'Không được vượt khối lượng yêu cầu (${availableQty.removeTrailingZero} kg)';
                      }
                      return null;
                    },
                  ),
