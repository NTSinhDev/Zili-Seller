...
class _IngredientCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return WarehouseProductCard(
      variant: variant,
      extraRows: [MapEntry('Khối lượng:', '${item.totalWeight.toUSD} ${variant.displayUnit}')],
    );
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(color: AppColors.greyC0, width: 1),
      ),
      child: RowWidget(
