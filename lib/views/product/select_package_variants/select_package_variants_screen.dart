...
class SelectPackageVariantsScreen extends StatefulWidget {
  static String routeName = '/select-package-variants';
  final dynamic routeArguments;
  const SelectPackageVariantsScreen({super.key, this.routeArguments});

  @override
  State<SelectPackageVariantsScreen> createState() => _SelectPackageVariantsScreenState();
}

class _SelectPackageVariantsScreenState extends State<SelectPackageVariantsScreen> {
  ...
  void _loadInitialData() {
    _prodCubit.filterPackageVariants();
  }
  ...
  Future<void> _onRefresh() async {
    ...
    await _prodCubit.filterPackageVariants(keyword: _currentKeyword);
  }
