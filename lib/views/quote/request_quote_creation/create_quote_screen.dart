...
import 'components/quotation_type_selector.dart';
...
class QuotationCreationScreen extends StatefulWidget {
  ...
  const QuotationCreationScreen({super.key, this.input});
  static String keyName = '/create-quotation';

  @override
  State<QuotationCreationScreen> createState() =>
      _QuotationCreationScreenState();
}
...
class _QuotationCreationScreenState extends State<QuotationCreationScreen> {
          ...
          bottomNavigationBar: _BottomActionBar(
            ...
            onCreateOrder: () {
              ...
              if (result != null) {
                ...
                _orderCubit.createQuotation(_createQuotationInput);
              }
            },
          ),
        ),
  ...
  void _listener(BuildContext context, OrderState state) {
    if (state is LoadingOrderState) {
      ...
      CustomSnackBarWidget(
        context,
        message: state.error ?? "Không thể tạo phiếu báo giá!",
        type: .error,
      ).show();
    }
  }
  ...
  void _popInvoked(BuildContext context, bool didPop) {
    if (!didPop) {
      showNoticeDialog(
        ...
        title: 'Rời trang?',
        message:
            'Thông tin tạo báo giá sản phẩm sẽ mất, xác nhận để rời trang.',
        variant: .confirm,
