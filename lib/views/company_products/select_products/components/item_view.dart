...
class _ItemView extends StatelessWidget {
  ...
  final List<ProductVariant> temps;
  final Function(List<ProductVariant>) setTemps;
  const _ItemView(this.variant, {required this.temps, required this.setTemps});

  @override
  Widget build(BuildContext context) {
    final OrderRepository orderRepository = di<OrderRepository>();
    final displayPrice = '${variant.price.toUSD}${AppConstant.strings.VND}';
